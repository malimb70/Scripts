...
#
class domain_membership (
  $domain=$::domain_membership::params::domain,
  $username=$::domain_membership::params::username,
  $password=$::domain_membership::params::password,
  $secure_password=false,
  $machine_ou=undef,
  $resetpw=true,
  $join_options='1',
) inherits domain_membership::params
{

  notify { "$password and $username and $domain": }
  # Validate Parameters
